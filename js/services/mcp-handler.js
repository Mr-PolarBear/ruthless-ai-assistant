...
import { mcpExecutor, parseToolCalls } from '../mcp-core.js?v=260824';
import { renderToolCallResult, showToolCallLoading } from '../mcp-renderer.js?v=260824';
...
export async function handleToolCalls(content, messageElement, convId, msgIndex, continueConversationCallback) {
    ...
    try {
        ...
        for (let i = 0; i < results.length; i++) {
            ...
            import('../mcp-renderer.js?v=260824').then(({ renderToolCallResult }) => {
