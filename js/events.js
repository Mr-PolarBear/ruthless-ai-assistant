...
import { createNewConversation } from './main.js?v=260824';
import { setupUIEvents } from './ui-events.js?v=260824';
import { setupModalEvents } from './modal-events.js?v=260824';
import { setupChatEvents } from './chat-events.js?v=260824';
import { setupFileEvents } from './file-events.js?v=260824';
import { setupSettingsEvents } from './settings-events.js?v=260824';
    ...
    if (dom.newChatBtn) {
        dom.newChatBtn.addEventListener('click', async () => {
            ...
            if (window.innerWidth <= 768) {
                const { closeSidebarMobile } = await import('./ui-events.js?v=260824');
                closeSidebarMobile();
            }
        });
    }
