...
import { handleSendMessage, switchToConversation, switchBranch } from './main.js?v=260824';
import { closeSidebarMobile } from './ui-events.js?v=260824';
import { renderHistory } from './sidebar.js?v=260824';
import { renderChatMessages, formatMessagePipeline, renderFormattedContent } from './renderer.js?v=260824';
import {
...
import { showFileViewer } from './attachment.js?v=260824';
import { saveToLocalStorage, saveMessageAsFile, isMessageHidden } from './utils.js?v=260824';
import { deleteConversation, saveConversation, getConversation } from './db.js?v=260824';
import { openConversationAvatarModal, openQuickHideModal, openConvTitleModal, openExportConvModal, openBranchSummaryConfirmModal } from './modals.js?v=260824';
import { adjustTextareaHeight, updateSendButtonState, notify } from './ui-updater.js?v=260824';
import { getHideSummaryForConversation } from './main.js?v=260824';
import { checkBranchMemoryStatus } from './summary-manager.js?v=260824';
// 乌鸦：导入代码预览管理器，用于在切换会话时关闭侧边栏
import { codePreviewManager } from './code-preview-manager.js?v=260824';
import { eventBus, EVENTS } from './services/event-bus.js?v=260824';
